...
def register():
    ...
    return render_template( 'themes/phantom/layouts/default.html',
                            title=page_title,
                            content=render_template( 'themes/phantom/pages/register.html', form=form, msg=msg) )
...
def login():
    ...
    return render_template( 'themes/phantom/layouts/default.html',
                            title=page_title,
                            content=render_template( 'themes/phantom/pages/login.html', 
                                                     form=form,
                                                     msg=msg) )
...
def elements():
    ...
    # try to match the pages defined in -> themes/phantom/pages/
    return render_template('themes/phantom/layouts/default.html',
                            content=render_template( 'themes/phantom/pages/elements.html') )
...
def about():
    ...
    # try to match the pages defined in -> themes/phantom/pages/
    return render_template('themes/phantom/layouts/default.html',
                            content=render_template( 'themes/phantom/pages/about.html') )
...
def index(path):
    ...
    try:
        ...
        # try to match the pages defined in -> themes/phantom/pages/
        return render_template('themes/phantom/layouts/default.html',
                                content=render_template( 'themes/phantom/pages/'+path) )
    except:
        abort(404)
